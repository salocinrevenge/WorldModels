...
sudo apt-get update && sudo apt-get install pkg-config libhdf5-dev
...
Coloquei o dataset sketchy na pasta data/sketchy_data
no arquivo configs/sketchy.json, troquei ```root``` para:
```
  "root": "/home/nicolas/Programas/WorldModels/worldmodels/experiments/lpwm/lpwm/data/sketchy_data",
