...
try:
    ...
    from repro.streamer.streamer.utils.events import CounterDetector
    import repro.streamer.streamer.models.networks as networks
    from repro.streamer.streamer.core.demarcation import EventDemarcation
    from repro.streamer.streamer.core.loss import StreamerLoss
    from repro.streamer.streamer.core.buffer import MemBuffer
...
class StreamerLayer(nn.Module):
    ...
    def reset_layer(self):
        ...
        self.attn_img = None
        self.attns = None
        self.context = None # remove o contexto
    ...
    def forward(self, x, base_counter):
        ...
        if boundary:    # parte executada quando um novo evento vai ser criado
