...
def parser():
    ...
    parser.add_argument('--sample', type=str, default=None, help='Name of video to be analized, None if all')

    parser.add_argument('--f', type=str, default=None, help='Ignore, used only in notebook to dont crash')
