    ...
    def train(self):
        ...
        while n_eps < self.args.max_eps:
            ...
            while not done:
                ...
                next_state_from_env, score_i, done, info = env.step(action)
                ...
                inverse_action_prob = self.inverse_model(features)

                # Pass the correct action tensor to forward_model
                est_next_features = self.forward_model(action_tensor_for_icm, features[0:1])
                extrinsic_reward = 0.
